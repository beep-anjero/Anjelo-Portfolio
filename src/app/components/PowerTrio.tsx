  ...
  return (
    <section className="bg-[#fdfaf4] px-4 py-24 transition-colors duration-500 sm:px-6 lg:px-8 dark:bg-[#171512]">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {powerTrio.map((tech, index) => {
            ...
            return (
              <article
                key={tech.name}
                className="group border border-[#191714]/10 bg-[#f5f0e8] p-6 shadow-sm transition hover:-translate-y-1 hover:border-[#191714]/25 hover:shadow-xl dark:border-white/10 dark:bg-[#211e19] dark:hover:border-[#f4c542]/40 dark:hover:shadow-black/30"
              >
                ...
                <div className="mt-7 flex flex-wrap gap-2">
                  {tech.frameworks.map((framework) => (
                    <span
                      key={framework}
                      className="rounded-full border border-[#191714]/10 bg-white/70 px-3 py-1.5 font-mono text-xs font-semibold text-[#575047] dark:border-white/10 dark:bg-white/10 dark:text-[#d8cbbb]"
                    >
                      {framework}
                    </span>
                  ))}
        ...
        <div className="mt-5 grid gap-4 border border-[#191714]/10 bg-[#191714] p-5 text-[#f5f0e8] md:grid-cols-[auto_1fr] md:items-center dark:border-white/10 dark:bg-[#0f0e0c]">
